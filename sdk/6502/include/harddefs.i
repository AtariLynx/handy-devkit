...
*				Added READ_ENABLE definition for IODAT
* 12-Apr-90	SHL		Added SUZY_BASE and MIKEY_BASE definitions
*				Removed SUZY_ADDRESS definition
*				Corrected LEFT_ATTENMASK and RIGHT_ATTENMASK
...
A_BUTTON	.EQ OUTER_BUTTON
B_BUTTON	.EQ INNER_BUTTON
...
ATTENREG2	.DS 1	; FD42
ATTENREG3	.DS 1	; FD43
LEFT_ATTENMASK	.EQ %11110000
RIGHT_ATTENMASK	.EQ %00001111
...
HORIZONTAL_INT	.EQ TIMER0_INT
		...
		.OR $FD86
AUDIN		.DS 1	; FD86	; Audio in -or- cartridge r/w line
SYSCTL1		.DS 1	; FD87
...
READ_ENABLE	.EQ %00010000	; same bit for AUDIN_BIT
